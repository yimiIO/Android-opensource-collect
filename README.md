...
> 如果你也对开源实现库的实现原理感兴趣，加入 QQ 交流群：215253760(Android极客汇)  
> 不同于Trinea的是，这里只有中文版，我们会利用目录来区分不同类别的开源项目、组件。
> 欢迎加入我们，如果你需要添加其它项目，可以直接push过来，如果你懒得添加，只是想告诉我们一些不错的项目，或是发现已添加的项目中有已经过时的项目，请在to-be-added.md中告诉我们。  
